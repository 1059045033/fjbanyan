...
<script>
import {fetchManagerList, getManagerList,fetchList} from '@/api/regions'
...
export default {
  ...
  computed: {
    ...
    filteredTodos() {
      // console.log('filteredTodos = ',this.visibility);
      // console.log('filteredTodos todos = ',this.todos);
      ...
      fetchList(this.listQuery).then(response => {
        ...
        for (let i = 0; i < response.data.items.length; i++) {
          this.regionList.push({
            ...
            zhongxin:response.data.items[i]['zhongxin']
          })
        }
      })
    },
