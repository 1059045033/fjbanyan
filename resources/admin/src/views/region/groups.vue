<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.name" placeholder="组别名字" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
...
<script>
  ...
  import { regionGroupList, createRegionGroup, deleteRegionGroup } from '@/api/regiongroup'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        regionGroupList(this.listQuery).then(response => {
      ...
      createData() {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            createRegionGroup(this.temp).then((res) => {
              console.log(res)
      ...
      handleDelete(row, index) {
        deleteRegionGroup({ id: row.id }).then(($res) => {
          console.log($res)
          if ($res.code == 200) {
            this.$notify({
              title: '成功',
